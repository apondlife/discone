...
/// plays music using unity audio sources
public sealed class UnityMusicSource: MonoBehaviour {
    // -- tuning --
    [Header("tuning")]
    ...
    public void PlayChord(Chord chord, float interval, in Key? key = null) {
    ...
    public void PlayTone(Tone tone, in Key? key = null) {
